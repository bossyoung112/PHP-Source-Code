<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $newAction = "displayProductsbyCollapse";
        }
?>
<!doctype html>
<html lang="en">
    ...
    <body>
        ...
        <main>
            <form method="post" action="<?php echo $newAction;?>">
                ...
                <select class="form-select form-select-lg" name="selectYearC" id="">
                    <?php
                ...
                <select class="form-select form-select-lg" name="selectBandC" id="">
